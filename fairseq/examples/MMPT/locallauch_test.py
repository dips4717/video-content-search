...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 20 22:04:03 2022
...
if __name__ == "__main__":
    ...
    parser.add_argument("---yamls", type=str, default = 'projects/retri/videoclip/test_youcook_zs.yaml')
    parser.add_argument("--dryrun", action="store_true", help="run config and prepare to submit without launch the job.")
    parser.add_argument("--jobtype", type=str, default="local_predict", help="force to run jobs as specified.")
