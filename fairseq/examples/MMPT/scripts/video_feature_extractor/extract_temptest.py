...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 24 08:55:41 2022
...
parser.add_argument('--vdir', type=str, default = '/home/dipu/content_trading/data/vggsound/samples')
parser.add_argument('--fdir', type=str, default='vggsoundfeats')
