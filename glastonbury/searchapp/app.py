...
sys.path.append('/home/dipu/content_ps/code/fairseq/examples/MMPT/')
...
@st.cache
def model_load():
    model, tokenizer, aligner = MMPTModel.from_pretrained("/home/dipu/content_ps/code/fairseq/examples/MMPT/projects/retri/videoclip/how2.yaml")
    model.eval()
    model=model.cuda()
...
print(topk_fnames)
st.text(f'VideoCLIP feat extraction and search completed in {toc:2f} sec')
